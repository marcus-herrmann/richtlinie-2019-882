<template>
  <section class="section section--highlighted" id="links">
    <div class="section__inner">
      <h2>Links, Quellen, Materialien</h2>

      <p>(Ich erwarte, dass dieser Abschnitt der Seite wächst, je näher wir den nationalen legislativen Umsetzungen der EU-Mitgliedsstaaten kommen).</p>

      <p><a href="https://eur-lex.europa.eu/eli/dir/2019/882/oj?locale=de">Den vollständigen Text der Richtlinie 2019/882 finden Sie hier.</a>.</p>
